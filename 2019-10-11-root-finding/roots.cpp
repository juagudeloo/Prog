...
int main(void)
{
  ...
  double root = bisection(0, 200, EPS, fun, ITERMAX);
  std::cout << root << "\n";
  root = regulafalsi(0, 200, EPS, fun, ITERMAX);
  std::cout << root << "\n";
  root = fixedpoint(0, EPS, fun, gaux, ITERMAX);
  std::cout << root << "\n";
  root = newton_raphson(0, EPS, fun, deriv, ITERMAX);
  std::cout << root << "\n";
