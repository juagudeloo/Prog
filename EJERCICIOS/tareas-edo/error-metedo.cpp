//ESTE PROGRAMA HALLA EL ERROR DE LA APROXIMACIÓN DE LOS RESULTADOS DEL OSCILADOR ARMÓNICO POR MÉTODO DE EULER Y RUNGE-KUTTA DE CUARTO ORDEN.
...
void erreuler (double ta, double tb, double h, std::vector<double> &y);
double f(double t, const std::vector<double> &y, int id);
void errrk4 (double ta, double tb, double h, std::vector<double> & y);
std::ofstream fout ("datos-error-metodos.txt");
